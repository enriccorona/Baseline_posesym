...
%obj_file = loadawobj('../Desktop/prova.obj');
%obj_file = loadawobj('../Desktop/prova_cylinder.obj');
%obj_file = loadawobj('../Desktop/Models_obj/Model_13.obj');
%V = obj_file.v';
%F = obj_file.f3';
...
[C, symIdx] = refine_C(eigvector, C0, eigvector, 20, 10);

%Visualization
%fprintf('Visualization.\n');
%plot_C2Shape(V,F,eigvector, C, inn',1:size(symIdx,1), symIdx);
%fprintf('Done.\n');
